...
func (ph *ReceptionsHandler) CloseReception(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	...
	reception, err := ph.Mgr.ReceptionService.Close(r.Context(), pvzID)
	if err != nil {
	...
	common.JsonResponse(w, http.StatusOK, reception)
}
